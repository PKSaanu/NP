export default function Education() {
  return (
    <section id="education" className="mb-8 bg-gray-800 bg-opacity-50 p-6 rounded-lg backdrop-blur-sm shadow-lg">
      <h2 className="text-[clamp(1.25rem,4vw,1.5rem)] font-bold mb-4 text-purple-400">Education</h2>
      <ul className="space-y-4">
        <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:bg-purple-500 before:rounded-full">
          <h3 className="font-semibold text-[clamp(1rem,3vw,1.125rem)]">PhD in Computer Science</h3>
        ...
        <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:bg-purple-500 before:rounded-full">
          <h3 className="font-semibold text-[clamp(1rem,3vw,1.125rem)]">Bachelor of Science (Specialisation in Computer Science)</h3>
